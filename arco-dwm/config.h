...
static const char *fonts[] = {"Terminess Nerd Font:pixelsize=18:antialias=true:autohint=true"};
// static const char *fonts[] = {"Source Code Pro Medium:size=14"};
static const char dmenufont[] = "Source Code Pro Medium:size=14";
...
static Key keys[] = {
    ...
    {MODKEY, XK_Print, spawn, {.v = shotwin}},
    {ALTKEY, XK_Print, spawn, {.v = shotarea}},
