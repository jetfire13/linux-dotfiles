...
vim.api.nvim_create_autocmd('LspAttach', {
    group = vim.api.nvim_create_augroup('telescope-lsp-attach', { clear = true }),
        ...
        -- Useful when your language has ways of declaring types without an acimplementation.
        vim.keymap.set('n', 'gi', builtin.lsp_implementations, { buffer = buf, desc = '[G]oto [I]mplementation' })

        -- Jump to the definition of the word under your cursor.
        -- This is where a variable was first declared, or where a functiodefined, etc.
        ...
        vim.keymap.set('n', 'gW', builtin.lsp_dynamic_workspace_symbols, { buffbuf, desc = 'Open Workspace Symbols' })
